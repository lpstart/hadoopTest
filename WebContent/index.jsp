...
<body style="text-align:center;margin-bottom:100px;">
	     ...
	     <div class="navbar-inner">
	       ...
	       <ul class="nav">
	         ...
	         <li><a href="LogoutServlet.do">退出</a></li>
	   ...
	   <form class="form-inline"  method="POST"  enctype="MULTIPART/FORM-DATA"   action="UploadServlet.do" >
			...
			for (int i=0; i<list.length; i++) {
				%>
					...
					%>
						...
						<td><a href="DeleteFileServlet.do?filePath=<%=java.net.URLEncoder.encode(list[i].getPath().toString(),"GB2312") %>">x</a></td>
						<td><a href="DownloadServlet.do?filePath=<%=java.net.URLEncoder.encode(list[i].getPath().toString(),"GB2312")%>">下载</a></td>
